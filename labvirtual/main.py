...
# Autores: Oséias Farias; Yuri Costa
...
class RunLabvirtual:
    ...
    def run_aeropendulo(self):
        ...
        # Instânciando um objeto para solução matemática
        # do sistema Aeropêndulo.
        Km = 0.0296
        m = 0.36
        d = 0.03
        J = 0.0106
...
if __name__ == "__main__":
    run_lab = RunLabvirtual()
    run_lab.run_aeropendulo()
